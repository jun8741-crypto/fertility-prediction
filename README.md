...
> **🏆 AI헬스케어 3기 해커톤 2등** (DACON × 오즈코딩스쿨, 2026-04)
>
> 25만 건 임상 데이터 기반 임신 성공 여부 예측 (ROC-AUC) · **Public LB 0.7423993**

| 역할 | 대회 · 맥락 | 기간 | 성과 |
|---|---|---|---|
| **팀장 (3명, 9조)** | AI헬스케어 3기 해커톤 (DACON × 오즈코딩스쿨) | 2026.04 | 🏆 **2등** · Public LB 0.7423993 |
